    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('contacts.fields.store') }}" method="POST" x-data="{ fieldType: '{{ old('type', 'text') }}' }">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input 
                                ...
                                required 
                                autofocus
                                placeholder="Ex: Empresa, Cargo, Aniversário..."
                            />
