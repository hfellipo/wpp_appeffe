                        ...
                        <div class="funnel-drop-zone flex flex-col rounded-lg border border-gray-200 {{ $sc['bg'] }} transition-colors flex-shrink-0" style="min-height: 320px; width: {{ $colWidth }}px;" data-stage-id="{{ $stage->id }}">
                            <div class="px-3 py-2 border-b border-gray-200/80">
                                <div class="flex items-center justify-between gap-1 mb-1.5">
                                    ...
                                    @endphp
                                    <button type="button"
                                            class="stage-automation-btn p-1 rounded {{ $stage->automation_id ? 'text-blue-600 hover:bg-blue-50' : 'text-gray-400 hover:bg-gray-100' }}"
                                            title="{{ $stage->automation_id ? __('Automação configurada') : __('Disparo / Eventos / Automação') }}"
